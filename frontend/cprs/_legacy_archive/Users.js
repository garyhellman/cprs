Ext.define('CPRS.controller.Users', {
	...
	afterConfirmDeleteUser: function(btn) {
		if (btn === 'yes') {
			...
			if (record) {
				...
				this.doGridRefresh();
				CPRS.component.Notification.info(i18n.successful, i18n.user_deleted);
			}
		}
	},
	...
	updateUser: function(button) {
		...
		form.getForm().submit({
			...
			success: function(form, action) {
				...
				CPRS.component.Notification.info(i18n.successful, i18n.user_saved);
			}
		});
	},
